...
const AlertDialog = withScrollPreserve(AlertDialogPrimitive.Root);
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        // No fechamento, evitamos que o Radix devolva o foco ao trigger sem
        // preventScroll — impede scroll-to-top quando o trigger foi desmontado.
        onCloseAutoFocus={(e) => {
          e.preventDefault();
          onCloseAutoFocus?.(e);
        }}
