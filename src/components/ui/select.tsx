...
>(({ className, children, position = "popper", collisionPadding = 12, onCloseAutoFocus, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      collisionPadding={collisionPadding}
      // Evita que o Radix devolva o foco ao trigger com scroll — quando o
      // trigger está fora da viewport, o navegador rola até o topo.
      onCloseAutoFocus={(e) => {
        e.preventDefault();
        onCloseAutoFocus?.(e);
      }}
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          position === "popper" &&
            "w-full min-w-[var(--radix-select-trigger-width)] max-h-[var(--radix-select-content-available-height,24rem)] overflow-y-auto overscroll-contain touch-pan-y",
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
