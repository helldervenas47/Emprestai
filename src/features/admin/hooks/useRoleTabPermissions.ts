...
const DEFAULT_ROLE_TABS: Record<string, string[]> = {
  cliente: ["overview", "dashboard", "products", "vehicles", "calendar", "clients", "expenses", "boletos", "salary", "accountant", "telegram_reports", "metas", "video_lessons", "settings"],
  gerente: ["overview", "dashboard", "products", "vehicles", "calendar", "clients", "expenses", "boletos", "salary", "accountant", "telegram_reports", "metas", "video_lessons", "settings"],
  visualizador: ["overview", "dashboard", "clients", "calendar", "telegram_reports", "video_lessons"],
};
