  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent
        ...
        className="top-0 left-0 translate-x-0 translate-y-0 box-border w-[100dvw] h-[100dvh] max-w-[100dvw] max-h-[100dvh] rounded-none border-0 overflow-y-auto overflow-x-hidden sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:w-full sm:h-auto sm:max-w-lg sm:max-h-[90vh] sm:rounded-2xl sm:border"
      >
        <DialogHeader>
          <DialogTitle>{initial ? "Editar receita" : "Nova receita"}</DialogTitle>
          <DialogDescription>
            Preencha descrição, valor, data, categoria e forma de recebimento.
          </DialogDescription>
        </DialogHeader>
