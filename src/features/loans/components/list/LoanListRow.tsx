            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              {!readOnly && loan.status !== "paid" ? (
                <div onClick={(e) => e.stopPropagation()} className="w-full">
                  {/* Versão Mobile: Grid 3 colunas nas 2 primeiras linhas e 2 botões largos na 3ª linha */}
                  <div className="grid grid-cols-3 gap-2 w-full md:hidden">
                    ...
                    {/* Linha 3: Editar e Excluir ocupam toda a largura (50% cada) */}
                    <div className="col-span-3 grid grid-cols-2 gap-2 w-full">
                      <Button
                        type="button"
                        variant="outline"
                        className="w-full h-9.5 px-2 text-xs font-medium gap-1.5 rounded-xl border-border/70 hover:border-primary/50 justify-center"
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        className="w-full h-9.5 px-2 text-xs font-medium gap-1.5 rounded-xl border-destructive/30 text-destructive hover:bg-destructive/10 hover:text-destructive justify-center"
                  ...
                  {/* Versão PC: Grade 4x4 (4 botões na linha 1 e 4 botões na linha 2) */}
                  <div className="hidden md:grid md:grid-cols-4 md:gap-2 w-full">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full h-10 px-3 text-sm font-medium gap-1.5 rounded-xl border-destructive/30 text-destructive hover:bg-destructive/10 hover:text-destructive justify-center"
                      onClick={(e) => { e.stopPropagation(); setConfirmDelete(true); }}
                    >
                      <Trash2 className="h-3.5 w-3.5 shrink-0" />
                      <span className="truncate">Excluir</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 w-full" onClick={(e) => e.stopPropagation()}>
                  <Button
                    type="button"
                    variant="outline"
                  ...
                  {!readOnly && (
                    <>
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        className="w-full h-9.5 sm:h-10 px-2 sm:px-3 text-xs sm:text-sm font-medium gap-1.5 rounded-xl border-destructive/30 text-destructive hover:bg-destructive/10 hover:text-destructive justify-center"
                        onClick={(e) => { e.stopPropagation(); setConfirmDelete(true); }}
                      >
                        <Trash2 className="h-3.5 w-3.5 shrink-0" />
                        <span className="truncate">Excluir</span>
