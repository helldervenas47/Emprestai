-- ============================================================================
-- Migração: Persistência de Username no Cadastro de Novos Usuários
-- 
-- Corrige a trigger `handle_new_user` para persistir `username`, `phone` e `cpf_cnpj`
-- a partir de `NEW.raw_user_meta_data`.
-- Também atualiza `billing_admin_list` para fazer fallback seguro para os metadados de auth
-- e realiza o backfill de usuários existentes que possuem username nos metadados.
-- ============================================================================

-- 1. Atualiza handle_new_user para salvar username e demais campos do cadastro
...
-- 2. Backfill: Preenche o username em profiles para usuários existentes que tenham username em raw_user_meta_data
...
-- 3. Atualiza billing_admin_list para retornar sempre o username com fallback garantido
